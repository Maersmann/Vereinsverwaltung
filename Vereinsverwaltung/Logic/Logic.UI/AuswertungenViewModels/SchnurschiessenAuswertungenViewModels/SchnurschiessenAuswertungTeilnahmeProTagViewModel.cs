...
{
    public class SchnurschiessenAuswertungTeilnahmeProTagViewModel : ViewModelAuswertung<AuswertungTagAnzahlModel>
    {
        private int jahr;
        public SchnurschiessenAuswertungTeilnahmeProTagViewModel()
        {
            Title = "Neuer Rang";
        ...
        private async void ExcecuteLoadDataCommand()
        {
            ...
            {
                ItemList = await resp.Content.ReadAsAsync<List<AuswertungTagAnzahlModel>>();
                SetDataIntoChart();
            }
        ...
        private void SetDataIntoChart()
        {
            ...
            var auswertungSeries = new ColumnSeries<AuswertungTagAnzahlModel>
            {
                Values = ItemList,
